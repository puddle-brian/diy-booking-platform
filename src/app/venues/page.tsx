      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-black text-white rounded-xl p-8 mt-12 text-center">
                        <h3 className="text-2xl font-bold mb-4">Don't see your city?</h3>            <p className="text-lg mb-6 opacity-90">Help us build the directory by adding spaces in your area</p>            <a href="/venues/submit" className="bg-white text-black px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors font-medium">
              Submit a Space
            </a>
          </div>
        </div>
