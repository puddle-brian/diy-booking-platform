...
export default function FeedbackWidget() {
  ...
  return (
    <>
      {/* Floating Feedback Button - More Prominent */}
      {!isOpen && (
        <button
          onClick={() => setIsOpen(true)}
          className="fixed bottom-6 right-6 z-50 bg-blue-600 text-white px-6 py-4 rounded-full shadow-xl hover:bg-blue-700 hover:scale-105 transition-all duration-200 flex items-center group animate-pulse"
        >
