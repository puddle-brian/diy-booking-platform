          ...
          <div className="px-4 py-8 text-center">
            ...
            {permissions.canEditShow(show) && (
              <UnifiedActionButton
                ...
                className="border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-900 hover:border-gray-400 transition-all duration-150"
              >
                Add Artist
              </UnifiedActionButton>
            )}
